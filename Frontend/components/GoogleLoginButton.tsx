...
export function GoogleLoginButton({ googleLoading = false, setGoogleLoading }: GoogleLoginButtonProps) {
    ...
    return (
        <button
            ...
            className="w-full py-3 bg-white text-on-surface hover:cursor-pointer font-bold rounded-full border border-outline shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed text-gray-600 hover:scale-[1.02] active:scale-95 "
        >
